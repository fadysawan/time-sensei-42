...
export const TradeTimeTracker: React.FC = () => {
  ...
  const { currentTime, newYorkTime, tradingStatus, currentPeriod, nextEvent } = useTradeTime(parameters);
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container flex h-16 items-center justify-between px-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-6 text-sm text-muted-foreground">
              ...
              <div className="flex items-center space-x-2">
                <span>New York:</span>
                <span className="font-mono text-foreground">{newYorkTime}</span>
              </div>
            </div>
          </div>
      ...
      <main className="container px-6 py-8">
        <div className="space-y-6">
          {/* Current Status and Next Events Row */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Next Events Panel */}
            <NextEventsPanel parameters={parameters} />
          </div>
